# Всем привет в этой репе мы создадим с вами свою базу данных на виртуальной машине VirtualBox. В своих листингах я использовал образ Debian, однако эту работу можно будет выполнить на любом образе.
# Ну чтож, приступим!!

## Установка PostgreSQL 
Официальная документация <https://www.postgresql.org/download/linux/ubuntu/>

### Загрузки для Linux (Ubuntu, Debian) 
...
**Внимание!!**
> Прошу заметить, что если мы опираемся на теорию бд, то обозначение ФИО в одном атрибуте совершенно неверно. Для этого обычно создают отдельные атрибуты отношения с фамилией, именем и отчеством. Но так как это всего лишь ознакомление, то я принебрёг этим. Не допускайте таких случаев, это важно!!
